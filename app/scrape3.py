...
chrome_path = '/Users/surf/Desktop/teamF/app/chromedriver'
...
for _ in range(1):
    ...
    if soup_result.find(class_="Pager__list Pager__list--next") is not None:
...
df.to_csv('after_scrape_results.csv')
